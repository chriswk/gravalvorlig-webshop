            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="role.rolename.label" default="Rolename" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="role.displayname.label" default="Displayname" /></td>
