            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.bigImage.label" default="Big Image" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productInstance, field: "bigImage")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.thumbnail.label" default="Thumbnail" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productInstance, field: "thumbnail")}</td>
